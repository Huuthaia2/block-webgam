	...
	class o {
		...
		static addInterstitial(t, r = this._fb_init_ad_count) {
			...
			for (let e = 0; e < r; e++) {
				...
				this._interstitialAds.push(i), console.log("Add Interstitial")
			}
		...
		static addRewardedVideo(t, r = this._fb_init_ad_count) {
			...
			for (let e = 0; e < r; e++) {
				...
				this._rewardedVideos.push(i), console.log("Add RewardedVideo")
			}
		...
		static addBanner(e) {
			...
			return this._banners.push(t), console.log("Add Banner"), t
		}
		static loadAll() {
			return c(this, void 0, void 0, function* () {
		...
		static loadAllAsync() {
			return c(this, void 0, void 0, function* () {
				console.log("FBAdManager Version: " + this.getVersion()), console.log("Init Ads");
